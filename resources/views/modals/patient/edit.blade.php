<div class="modal fade" id="editPatient" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="#" method="POST" id="edit-patient-form" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" value="" name="scheduled_appointment" id="edit_scheduled_appointment" min={{date('Y-m-d')}}>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        @component('components.inputs.input')
                            ...
                            @slot('attributes', [
                                ...
                                'id' => 'edit_reasons_for_consultation',
